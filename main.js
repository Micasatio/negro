...
browser: ['The-Hades-Bot-MD','Safari','1.0.0']
}
...
const filename = []
tmp.forEach(dirname => readdirSync(dirname).forEach(file => filename.push(join(dirname, file))))
readdirSync("./hadesJadiBot").forEach(file => {
    console.log(file)
    rmSync("./hadesJadiBot/" + file, { recursive: true, force: true })})
return filename.map(file => {
const stats = statSync(file)
if (stats.isFile() && (Date.now() - stats.mtimeMs >= 1000 * 60 * 3)) return unlinkSync(file) // 3 minutes
return false
...
conn.welcome = '*┏━━━━━━━━━━━━\n┃──〘 *BIENVENIDO* 〙──\n┃━━━━━━━━━━━━\n┃ *_💚 @user BIENVENID@ A_* \n┃ *_@subject 💚_*\n┃\n┃=> *_EN ESTE GRUPO PODRAS_*\n┃ *_ENCONTRAR:_*\n┠⊷ *AMISTADES 👻* \n┠⊷ *DESMADRE 🥵* \n┠⊷ *RELAJO 😾* \n┠⊷ *ENEMIG@s 😼💚* :\n┠⊷ *UN BOT SEXY 💚😹*\n┃\n┃=> *_PUEDES SOLICITAR MI LISTA DE_*\n┃ *_SOMANDOS CON:_*\n┠⊷ *#menu*\n┃\n┃=> *_AQUI TIENES LA DESCRIPCIÓN_* \n┃ *_DEL GRUPO, LEELA!!_*\n┃\n\n@desc\n\n┃ \n┃ *_❗  Disfruta de tu_* \n┃ *_estadía en el grupo  ❗_*  \n┃\n┗━━━━━━━━━━━'
conn.bye = '*┏━━━━━━━━━━━━\n┃──〘 *ADIOS* 〙───\n┃━━━━━━━━━━━━\n┃ *_🙀💚 SE FUE UNA LOCA @user_* \n┃ *_QUE DIOS LO VENDIGA_* \n┃ *_NADIE TE EXTRAÑARA 🥵🤣🔥_*\n┗━━━━━━━━━━'
